...
- [doctr](https://github.com/publicMindee/doctr/blob/master/doctr) - The actual doctr library
- [test](https://github.com/publicMindee/doctr/blob/master/test) - Python unit tests
- [docs](https://github.com/publicMindee/doctr/blob/master/docs) - Library documentation building
...
Use Github [issues](https://github.com/publicMindee/doctr/issues) for feature requests, or bug reporting. When doing so, use issue templates whenever possible and provide enough information for other contributors to jump in.
