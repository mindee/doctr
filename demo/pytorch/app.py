        ...
        if uploaded_file is None:
            ...
            with st.spinner('Loading model...'):
                predictor = ocr_predictor(
                    ...
                    assume_straight_pages=(det_arch != "linknet_resnet50_rotation")
                ).to(device)
            ...
            with st.spinner('Analyzing...'):
                ...
                with torch.no_grad():
                    ...
                    seg_map = out["out_map"]
                    seg_map = torch.squeeze(seg_map)
                    seg_map = cv2.resize(seg_map.to("cpu").numpy(), (doc[page_idx].shape[1], doc[page_idx].shape[0]),
                ...
                if det_arch != "linknet_resnet50_rotation":
