...
default_cfgs: Dict[str, Dict[str, Any]] = {
    "resnet18": {
        ...
        "url": "https://github.com/mindee/doctr/releases/download/v0.9.0/resnet18-f42d3854.weights.h5",
    },
    "resnet31": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.9.0/resnet31-ab75f78c.weights.h5",
    },
    "resnet34": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.9.0/resnet34-03967df9.weights.h5",
    },
    "resnet50": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.9.0/resnet50-82358f34.weights.h5",
    },
    "resnet34_wide": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.9.0/resnet34_wide-b18fdf79.weights.h5",
    },
}
