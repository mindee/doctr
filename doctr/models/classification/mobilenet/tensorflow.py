...
default_cfgs: Dict[str, Dict[str, Any]] = {
    "mobilenet_v3_large": {
        ...
        "url": "https://github.com/mindee/doctr/releases/download/v0.9.0/mobilenet_v3_large-d857506e.weights.h5",
    },
    "mobilenet_v3_large_r": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.9.0/mobilenet_v3_large_r-eef2e3c6.weights.h5",
    },
    "mobilenet_v3_small": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
    ...
    "mobilenet_v3_small_r": {
        ...
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.9.0/mobilenet_v3_small_r-dd50218d.weights.h5",
    },
    "mobilenet_v3_small_crop_orientation": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        ...
        "classes": [0, -90, 180, 90],
        "url": "https://github.com/mindee/doctr/releases/download/v0.9.0/mobilenet_v3_small_crop_orientation-ef019b6b.weights.h5",
    },
    "mobilenet_v3_small_page_orientation": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        ...
        "classes": [0, -90, 180, 90],
        "url": "https://github.com/mindee/doctr/releases/download/v0.9.0/mobilenet_v3_small_page_orientation-0071d55d.weights.h5",
    },
}
