...
default_cfgs: Dict[str, Dict[str, Any]] = {
    "textnet_tiny": {
        ...
        "url": "https://github.com/mindee/doctr/releases/download/v0.7.0/textnet_tiny-9e605bd8.zip",
    },
    "textnet_small": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.7.0/textnet_small-4784b292.zip",
    },
    "textnet_base": {
        "mean": (0.694, 0.695, 0.693),
        "std": (0.299, 0.296, 0.301),
        "input_shape": (32, 32, 3),
        "classes": list(VOCABS["french"]),
        "url": "https://github.com/mindee/doctr/releases/download/v0.7.0/textnet_base-2c3f3265.zip",
    },
}
