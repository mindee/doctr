...
@pytest.mark.parametrize(
    ...
    [
        ...
        [[[0, 0.3, 0.4, 0.45, 0], [0.5, 0.28, 0.75, 0.42, 0], [0, 0.45, 0.1, 0.55, 0]], [0, 1, 2]],  # 2 lines
        [[[0, 0.3, 0.4, 0.35, 0], [0.75, 0.28, 0.95, 0.42, 0], [0, 0.45, 0.1, 0.55, 0]], [0, 1, 2]],  # 2 lines
    ],
)
...
@pytest.mark.parametrize(
    "input_boxes, lines",
    [
        [[[0, 0.5, 0.1, 0.6, 0], [0, 0.3, 0.2, 0.4, 0], [0, 0, 0.1, 0.1, 0, 0]], [[2], [1], [0]]],  # vertical
        [[[0.7, 0.5, 0.85, 0.6, 0], [0.2, 0.3, 0.4, 0.4, 0], [0, 0, 0.1, 0.1, 0]], [[2], [1], [0]]],  # diagonal
        ...
        [[[0, 0.3, 0.48, 0.45, 0], [0.5, 0.28, 0.75, 0.42, 0], [0, 0.45, 0.1, 0.55, 0]], [[0, 1], [2]]],  # 2 lines
        [[[0, 0.3, 0.4, 0.35, 0], [0.75, 0.28, 0.95, 0.42, 0], [0, 0.45, 0.1, 0.55, 0]], [[0], [1], [2]]],  # 2 lines
    ],
)
