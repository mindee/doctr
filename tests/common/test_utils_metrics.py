...
@pytest.mark.parametrize(
    ...
    [
        ...
        [[[[0, 0], [1., 0], [1., 1.], [0, 1.]]], [[[.5, .5], [1, .5], [1, 1], [.5, 1]]], 0.25, 0],  # Partial match
        [[[[.2, .2], [.6, .2], [.6, .6], [.2, .6]]], [[[.4, .4], [.8, .4], [.8, .8], [.4, .8]]], 4 / 28, 7e-3],  # Partial match
        [[[[0, 0], [.05, 0], [.05, .05], [0, .05]]], [[[.5, .5], [1, .5], [1, 1], [.5, 1]]], 0, 0],  # Boxes far from each other
...
@pytest.mark.parametrize(
    "gts, preds, iou_thresh, recall, precision, mean_iou",
    [
        [[[[[.05, .05], [.15, .05], [.15, .15], [.05, .15]]]], [[[[.05, .05], [.15, .05], [.15, .15], [.05, .15]]]], 0.5, 1, 1, 1],  # Perfect match
        [[[[[.1, .05], [.2, .05], [.2, .15], [.1, .15]]]], [[[[.1, .05], [.3, .05], [.3, .15], [.1, .15]], [[.6, .6], [.8, .6], [.8, .8], [.6, .8]]]], 0.2, 1, 0.5, 0.25],  # Bad match
        [[[[[.05, .05], [.15, .05], [.15, .15], [.05, .15]]], [[[.25, .25], [.35, .25], [35, .35], [.25, .35]]]], [[[[.05, .05], [.15, .05], [.15, .15], [.05, .15]]], None], 0.5, 0.5, 1, 1],  # Empty
    ],
)
