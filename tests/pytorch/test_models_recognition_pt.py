...
@pytest.mark.parametrize(
    ...
    [
        ["crnn_vgg16_bn", (3, 32, 128), [True, False]],
        ["crnn_mobilenet_v3_small", (3, 32, 128), [True, False]],
        ["crnn_mobilenet_v3_large", (3, 32, 128), [True, False]],
        ["sar_resnet31", (3, 32, 128), [True, False]],
        ["master", (3, 32, 128), [True, False]],
        ["vitstr_small", (3, 32, 128), [True, False]],
        ["vitstr_base", (3, 32, 128), [True, False]],
        ["parseq", (3, 32, 128), [True, False]],
    ],
)
